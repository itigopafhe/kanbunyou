...
const kuhouSearchBox = document.getElementById('kuhou-search-box'), gokuSearchBox = document.getElementById('goku-search-box');
        ...
        document.addEventListener('click', (e) => {
            ...
            if (target.classList.contains('tr-goku-tag-chip')) { const t = target.dataset.tag; const arr = trainingState.settings.gokuTags; const i = arr.indexOf(t); if (i>-1) arr.splice(i,1); else arr.push(t); renderTraining(); return; }
